...
namespace Kuyuri.UIToolkitExtensions
{
    ...
    public class MinMaxSliderWithValue : VisualElement
    {
        ...
        private VisualElement CreateStructure()
        {
            ...
            lowLimitLabel.style.fontSize = LabelFontSize;
            ...
            highLimitLabel.style.fontSize = LabelFontSize;
            ...
            minValueLabel.style.fontSize = LabelFontSize;
            ...
            maxValueLabel.style.fontSize = LabelFontSize;
